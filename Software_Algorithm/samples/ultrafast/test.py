...
while True:
    ...
    command_cam0 = f"ffmpeg -f v4l2 -framerate 24 -video_size 1280x720 -input_format mjpeg -i /dev/video0 -preset ultrafast -pix_fmt yuv420p -t 20 {filename_cam0}"
    command_cam2 = f"ffmpeg -f v4l2 -framerate 24 -video_size 1280x720 -input_format mjpeg -i /dev/video2 -preset ultrafast -pix_fmt yuv420p -t 20 {filename_cam2}"
    ...
    # Wait for 5 seconds before capturing the next set of videos
    time.sleep(5)
